...
import de.aaaaaaah.velcom.shared.protocol.exceptions.SerializationException;
...
class SimpleJsonSerializerTest {
	...
	void roundtrip() {
		...
		Assertions.assertThat(serializer.deserialize(serialized, RunnerWorkOrder.class))
			.isEqualTo(input);
	}
