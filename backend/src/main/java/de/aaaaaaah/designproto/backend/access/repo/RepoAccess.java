package de.aaaaaaah.designproto.backend.access.repo;
...
import de.aaaaaaah.designproto.backend.access.repo.exception.AddRepoException;
import de.aaaaaaah.designproto.backend.access.repo.exception.DeleteRepoException;
import de.aaaaaaah.designproto.backend.access.repo.exception.NoSuchRepoException;
import de.aaaaaaah.designproto.backend.access.repo.exception.RepoAccessException;
...
import de.aaaaaaah.designproto.backend.storage.repo.exception.RepositoryAcquisitionException;
