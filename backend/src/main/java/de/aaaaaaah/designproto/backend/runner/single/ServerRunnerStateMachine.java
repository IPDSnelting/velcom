package de.aaaaaaah.designproto.backend.runner.single;

import de.aaaaaaah.designproto.backend.access.commit.Commit;
import de.aaaaaaah.designproto.backend.runner.single.state.RunnerIdleState;
import de.aaaaaaah.designproto.backend.runner.single.state.RunnerState;
import de.aaaaaaah.designproto.backend.util.CheckedConsumer;
...
import de.aaaaaaah.designproto.runner.shared.protocol.serverbound.entities.RunnerInformation;
